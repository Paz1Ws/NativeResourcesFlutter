...
import 'package:myapp/infrastructure/repositories/pokemon_rpty_impl.dart';
import 'package:workmanager/workmanager.dart';

import '../infrastructure/repositories/isar_localdb_rpty_impl.dart';

const fetchBackgroundTaskKey = 'com.christopherpaz.miscelaneos.fetch-background-pokemon';
const fetchPeriodicBackgroundTaskKey = 'com.christopherpaz.miscelaneos.fetch-background-pokemon';
